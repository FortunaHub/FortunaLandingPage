      ...
      <section id="showcase" className="py-24 bg-fortuna-dark border-t border-white/5 scroll-mt-[5.5rem]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {[
            ...
            { num: "02", tag: "Network & Policy", title: "Zero Trust Policy Visualization", desc: "Visualize pods, traffic flows, and NetworkPolicies. Policy suggestions and drift detection.", bullets: ["Workload topology", "Allowed / blocked flow", "Policy suggestions · FIX NOW"], img: "network-designer.png", alt: "Network Designer", order: "img" },
